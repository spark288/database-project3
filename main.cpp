...
void errorTests();
void deleteRelation();
void createRelationForwardModified(int size);
void createRelationRandomModified(int size);
void intEmptyTest();
void intOneTest();
void intTestsNegative();
void indexTestsModified(int input);
...
void test4()
{
  std::cout << "---------------------" << std::endl;
	...
	createRelationRandomModified(0);
	indexTestsModified(0);
	deleteRelation();
}
void test5()
{
  std::cout << "---------------------" << std::endl;
	...
	createRelationRandomModified(600);
	indexTestsModified(1);
	deleteRelation();
}
